...
![Violet-theme](https://github.com/yummyhere/amitchauhan-v2/assets/85615075/25db6c35-f9e2-4c19-9060-cac2f0b544de)
![rose-theme](https://github.com/yummyhere/amitchauhan-v2/assets/85615075/f5dd1b90-3297-440d-a83c-d79c1cef7bd0)
![yellow-theme](https://github.com/yummyhere/amitchauhan-v2/assets/85615075/e5576e96-0d9d-4f37-a7ad-e14ffa5b1d21)
...
Copy `.env.example` to `.env.local`, set a long random `ADMIN_TOKEN`, and keep the SQLite `DATABASE_URL` value unless using another Prisma-supported database. Initialize and seed the database with:
...
The backend provides `POST /api/contact`, `GET /api/projects`, and `GET /api/skills`. The public pages read projects and skills from the database. The protected `/admin` page uses the `ADMIN_TOKEN` as a bearer token to show contact messages, create projects, and delete projects. Contact messages are persisted with their creation timestamp and rate limited to five submissions per hour per visitor.

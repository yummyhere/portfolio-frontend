        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              A web developer who turns ideas into modern, responsive, and
              user-friendly websites. I love clean UI, smooth interactions, and
              writing code that actually works. From simple landing pages to
              full web experiences, I build digital products that look good and
              feel even better.
            </p>
          </FadeUp>
          <FadeRight
